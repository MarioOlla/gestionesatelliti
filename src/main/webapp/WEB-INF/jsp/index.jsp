			  ...
			  <div class="container px-4 py-5" id="featured-3">
			    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
			      <div class="feature col">
			        ...
			        <p>Utilizza questa funzionalità per ricercare uno o piu satelliti presenti all' interno di questo sistema.</p>
			      ...
			      <div class="feature col">
			        ...
			        <p>Utilizza questa funzionalità per inserire un nuovo satellite a quelli già monitorati.</p>
